                ...
                <div className="container">
                    ...
                    <div className="reviews__wrapper">
                        <div className="col-1">
                            {mobile ? (
                                <>
                                    <div className="reviews__item reviews__item_359-deg">Thanks ! I just got it
                                        appreciate it I’ll difinitely be buying another one in the future
                                        👍🏾👍🏾🤘🏾🤘🏾🔥
                                    </div>
                                    <div className="reviews__item">recieved them.. They are perfect.. thank you for your
                                        serious 👍
                                    </div>
                                    <div className="reviews__item reviews__item_359-deg">Thank you very much!! It was
                                        fiery!!! The wait wasworth it 🔥🔥🔥🔥🖤🔥🖤🔥🖤🔥🖤🖤🔥🖤🔥🖤🔥
                                    </div>
                                    <div className="reviews__item reviews__item_359-deg">If someone ask me for a voice
                                        tag, i will recommand your work
                                    </div>
                                    <div className="reviews__item">Yo bro that’s sweet man thank you 🙏 love it</div>
                                    <div className="reviews__item reviews__item_0-deg">Man you da shit bruh these go
                                        I’ll be at you for more business 4sure 💯 and do you mix and master? I do too but
                                        i be getting bogged down i could use the help
                                    </div>
                                    <div className="reviews__item">amazing that’s exactly it 😍 you are incredible i
                                        don’t
                                        have the words ❤️
                                    </div>
